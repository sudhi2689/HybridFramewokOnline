...
public class LoginPage {
	...
	// @FindBy(xpath="//div[@class='pre-heade']//a[text()='Sign Out']") WebElement signOut;
	
	By signout=By.xpath("//a[contains(.,'Sign Out')]");
	...
	public void verifySignOutLink()
	{
		...
		Assert.assertEquals(text,"Sign Out","Sign out link not verified proprly");
